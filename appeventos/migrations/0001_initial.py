    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagenevento', models.ImageField(blank=True, default='eventos/logo.png', null=True, upload_to='eventos', verbose_name='Imagen del evento')),
                ('eventolink', models.CharField(blank=True, max_length=200, null=True, verbose_name='Link evento')),
                ...
                ('archivoevento', models.FileField(blank=True, max_length=500, null=True, upload_to='archivos', verbose_name='Video del evento:')),
