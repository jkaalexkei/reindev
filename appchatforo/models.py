...
class mensajechatforom(models.Model):
    ...
    autormensaje=models.ForeignKey(User,on_delete=models.CASCADE,related_name='autormensajechat', verbose_name='Autor:')
...
class respuestachatforom(models.Model):
    ...
    autorrespuesta=models.ForeignKey(User,on_delete=models.CASCADE,related_name='autorrespuestachat', verbose_name='Autor:')
